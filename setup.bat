...
if errorlevel 1 (
    ...
    "%PYTHON%" -m pip install openai httpx json-repair jieba fastapi "uvicorn[standard]" "sqlalchemy[asyncio]" aiosqlite pydantic python-dotenv sse-starlette -q -i https://mirrors.aliyun.com/pypi/simple/ --trusted-host mirrors.aliyun.com
)
echo [OK] Installed
